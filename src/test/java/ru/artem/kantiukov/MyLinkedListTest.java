...
public class MyLinkedListTest {
        ...
        public void clearTest(){
            ...
            list.add("Privet");
            list.clear();
            assertEquals(list.size(), 1); // Здесь немного непонятно, 1 потому что у нас есть head??
...
//        @DisplayName("Проверка метода lastIndexOf") здесь нужно правильно написать метод, а я не могу понять в чм дело
//        @Test
